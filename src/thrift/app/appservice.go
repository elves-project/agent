...
func NewAppServiceProcessor(handler AppService) *AppServiceProcessor {
	...
	self2 := &AppServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["runProcessor"] = &appServiceProcessorRunProcessor{handler: handler}
	return self2
}
