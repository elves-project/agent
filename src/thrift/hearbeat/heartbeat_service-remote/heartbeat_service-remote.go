...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string heartbeatPackage(AgentInfo info)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := hearbeat.NewHeartbeatServiceClientFactory(trans, protocolFactory)
	...
	case "heartbeatPackage":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "HeartbeatPackage requires 1 args")
			flag.Usage()
		}
		arg4 := flag.Arg(1)
		...
		argvalue0 := hearbeat.NewAgentInfo()
		...
		value0 := argvalue0
		fmt.Print(client.HeartbeatPackage(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
